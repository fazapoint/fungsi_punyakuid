        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="../adm_barang_hilang_tunda/hapus_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">HAPUS</a>
                    <a href="../adm_barang_hilang_tunda/detail_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">DETAIL</a>
                </td>
