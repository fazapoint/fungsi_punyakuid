    ...
    <table border="1">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="../adm_barang_hilang_tolak/hapus_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">HAPUS</a>
                    <a href="../adm_barang_hilang_tolak/detail_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">DETAIL</a>
                </td>
