    ...
    <table border="1">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="../adm_barang_hilang_terbit/tolak_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">TARIK</a>
                    <a href="../adm_barang_hilang_terbit/hapus_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">HAPUS</a>
                    <a href="../adm_barang_hilang_terbit/detail_barang_hilang.php?id_bh= <?php echo $d['id_bh']; ?>">DETAIL</a>
                </td>
